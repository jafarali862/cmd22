            ...
            <div class="card-body">
              ...
              <form action="{{ route('pharmacies.update', $pharmacy->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                 ...
                 @if ($pharmacy->pharmacy_photo)
                  <div class="form-group">
                    <label for="current_pharmacy_photo">Current Pharmacy Photo</label><br>
                ...
                <div class="form-group">
                  <label for="pharmacy_photo">New pharmacy Photo</label>
              ...
              <h5 class="mb-3">Account Information</h5>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="account_holder_name" name="account_holder_name"  value="{{ $pharmacy->account_holder_name }}" required>
                </div>

                <div class="form-group">
                  <label for="account_no">Account Number</label>
                  <input type="text" class="form-control" id="account_no" name="account_no"  value="{{ $pharmacy->account_no }}" required>
                </div>

                <div class="form-group">
                  <label for="ifsc">IFSC Code</label>
                  <input type="text" class="form-control" id="ifsc" name="ifsc"  value="{{ $pharmacy->ifsc }}" required>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="upi"  value="{{ $pharmacy->upi }}" name="upi" required>
                </div>
                  

                  @if ($pharmacy->qr_code)
                  <div class="form-group">
                    <label for="current_qr_photo">Current Qr Code</label><br>
                    <img src="{{ asset('storage/' . $pharmacy->qr_code) }}" alt="Current Qr Photo" width="100" height="100">
                  </div>
                @endif
